...
<table class="t1" border="1">
	...
	<tr>
		...
		<td><input type="text" name="codigo_residente" id="codigo_residente" value="<?php if($array_clientes_dalvian["codigo_residente"]){echo $array_clientes_dalvian["codigo_residente"];}?>" size="10"></td>
	</tr>
	<tr>
		<th>apellido</th>
	...
	<tr>
		...
		<td><input type="text" name="codigo_facturacion" id="codigo_facturacion" value="<?php if($array_clientes_dalvian["codigo_facturacion"]){echo $array_clientes_dalvian["codigo_facturacion"];}?>" size="10"></td>
	</tr>
...
/*
	<tr>
		...
		<td><input type="text" name="telefono" id="telefono" value="<?php if($array_clientes_dalvian["telefono"]){echo $array_clientes_dalvian["telefono"];}?>" size="10"></td>
		<td><input type="text" name="email" id="email" value="<?php if($array_clientes_dalvian["email"]){echo $array_clientes_dalvian["email"];}?>" size="10"></td>
			<td><textarea name="observaciones" id="observaciones" rows="10" cols="33"><?php if($array_clientes_dalvian["observaciones"]){echo $array_clientes_dalvian["observaciones"];}?></textarea></td>		<td><input type="text" name="imagen_nombre" id="imagen_nombre" value="<?php if($array_clientes_dalvian["imagen_nombre"]){echo $array_clientes_dalvian["imagen_nombre"];}?>" size="10"></td>
		<td><input type="text" name="fecha_creado" id="fecha_creado" value="<?php if($array_clientes_dalvian["fecha_creado"]){echo $array_clientes_dalvian["fecha_creado"];}?>" size="10"></td>
		<td><input type="text" name="fecha_modificado" id="fecha_modificado" value="<?php if($array_clientes_dalvian["fecha_modificado"]){echo $array_clientes_dalvian["fecha_modificado"];}?>" size="10"></td>
		<td><input type="text" name="codigo_facturacion" id="codigo_facturacion" value="<?php if($array_clientes_dalvian["codigo_facturacion"]){echo $array_clientes_dalvian["codigo_facturacion"];}?>" size="10"></td>
	</tr>
