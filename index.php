...
<body>
    <div class="login">
        <div class="panel-izquierdo">
            <img id="logo-dalvian" src="./assets/images/club_house.png">
        ...
        <table class="teclado-numerico">
            ...
            <tr class="cuarta-fila">
                <td><button><img id="limpiar" src="./assets/images/delete-all.png"></button></td>
                <td id="cero"><button>0</button></td>
                <td><button><img id="borrar" src="./assets/images/borrar.png"></button></td>
            </tr>
            <tr class="cuarta-fila">
                <th>Limpiar</td>
                    <th></td>
