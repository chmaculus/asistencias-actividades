...
?>
		...
		<form name="aa" action="<?php echo $_SERVER["SCRIPT_NAME"]; ?>" method="post">
			<input class="input_busqueda" type="text" name="busqueda" value="<?php echo $_POST["busqueda"]; ?>" placeholder="Numero Documento">
		...
		$sql = 'SELECT top 500 COD, NOM, DNI, DOM, CALLE, MZNA, CASA, PISO, DEPTO, TORRE, TEL, EMAIL FROM clientes where dni like \'%'.$_POST["busqueda"].'%\'  ';
