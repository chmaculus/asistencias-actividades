...
<head>
    ...
    <link href="../assets/css/clientes_ingreso.css" rel="stylesheet">
    ...
    <div class="cabecera">
        ...
        <table class="tabla-nav_buttons">
            <tr class="nav_buttons">
                ...
                <td class="botones_navegacion"><a href="clientes_asistencia_listado.php"><button><img src="../assets/images/listado.svg" alt="listita"></button></a></td>
            </tr>
            <tr>
                <td class="botones_navegacion">Ingresar</td>
                <td class="botones_navegacion">Buscar</td>
                <td class="botones_navegacion">DOSSA</td>
                <td class="botones_navegacion">Informes</td>
            </tr>
        </table>
    </div>
